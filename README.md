...
Hardware: ESP32-CAM Module (AI Thinker)
...
Actuation Phase: * Authorized: The ESP32 triggers the relay (GPIO 14) and Green LED (GPIO 12), unlocking the physical door for 10 seconds.
